...
The difference is px never changes makes it not responsive, % or vh are responsive static unit because they can change their size based on the screen size.
